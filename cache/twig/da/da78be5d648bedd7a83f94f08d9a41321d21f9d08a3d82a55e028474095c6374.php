...
/* @Page:/srv/users/serverpilot/apps/gravblogrosetree/public/user/pages/01.home */
class __TwigTemplate_80916f1d74e7b21a3ff4a579820f172310eddfc30ccee124987727c5b42bb245 extends Twig_Template
{
    ...
    {
        // line 1
        echo "<div class=\"container-fluid pl-0 pt-0 pr-0 pb-5 parallax\">
    <div class=\"row\">
        ...
        <div class=\"col-lg-4 pl-5 pr-5 pb-5 text-center\">
            ...
            <hr class=\"my-4\">
            <div class=\"grav-vimeo\"><iframe src=\"//player.vimeo.com/video/272694452\" frameborder=\"0\" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe></div>
        </div>
    </div>
</div>
<div class=\"box\"></div>
...
<section class=\"container p5 text-center\">
    ...
    ";
        // line 183
        echo $this->env->getExtension('UniteGalleryTwigExtension')->uniteGallery($this->getAttribute($this->getAttribute(($context["page"] ?? null), "media", array()), "images", array()), (("{\"gallery_theme\":\"" . $this->getAttribute($this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "unitegallery", array()), "gallery_theme", array())) . "\"}"));
        echo "
    </div>
    <p class=\"p-5\">
    ...
    {
        return "@Page:/srv/users/serverpilot/apps/gravblogrosetree/public/user/pages/01.home";
    }
    ...
    {
        return array (  206 => 183,  202 => 182,  19 => 1,);
    }
    ...
    {
        return new Twig_Source("<div class=\"container-fluid pl-0 pt-0 pr-0 pb-5 parallax\">
    <div class=\"row\">
        <div class=\"col-lg-8\"><img class=\"img-fluid\" src=\"user/images/getting-married.jpg\"></div>
        <div class=\"col-lg-4 pl-5 pr-5 pb-5 text-center\">
            <h1 class=\"display-3 pb-5 handwritten\">Getting Married?</h1>
...
</section>", "@Page:/srv/users/serverpilot/apps/gravblogrosetree/public/user/pages/01.home", "");
    }
}
